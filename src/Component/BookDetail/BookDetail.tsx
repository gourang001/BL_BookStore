...
function BookDetail() {
  ...
  const handleWishlist = async () => {
    try {
      if (isWishlisted) {
        ...
        console.log('Remove Wishlist API Response:', response);
      ...
      toast.error(errorMessage);
      if (errorMessage === 'No authentication token found. Please log in.' || error.response?.status === 401) {
        navigate('/login');
      }
    }
  };
  ...
  return (
    <div className="flex flex-col min-h-screen w-full overflow-x-hidden">
      ...
      <div className="md:ml-10 w-full box-border">
        <div className="flex-grow px-4 sm:px-6 md:px-8 lg:px-[90px] py-6 w-full box-border">
          <div className="flex flex-col md:flex-row gap-6 w-full">
            <div className="w-full md:w-[40%] flex flex-col">
              ...
              <div className="flex flex-col sm:flex-row gap-2 mt-4 justify-center sm:justify-end w-full">
                {addToCartState ? (
