  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isValid) {
      try {
        ...
        // Show success toast
        toast.success(`${container === 'login' ? 'Login' : 'Signup'} successful!`, {
          position: "top-right",
          autoClose: 3000,
        ...
        // Show error toast
        toast.error(`${container === 'login' ? 'Login' : 'Signup'} failed. ${container === 'signup' ? 'Email might already exist.' : 'Please check your credentials.'}`, {
          position: "top-right",
          autoClose: 3000,
          hideProgressBar: false,
          closeOnClick: true,
        ...
        setError(prev => ({ 
          ...prev, 
          email: `${container} failed. ${container === 'signup' ? 'Email might already exist.' : 'Please check your credentials.'}` 
        }));
      }
    }
  };
